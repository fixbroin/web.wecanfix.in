...
export async function generateMetadata(): Promise<Metadata> {
    const page = await getLegalPageContent('cancellation-policy');
    return {
        title: `${page?.title || 'Cancellation Policy'} | ${APP_NAME}`,
        description: `Read the Cancellation Policy for the ${APP_NAME} website and services.`,
        alternates: {
          canonical: `${WEBSITE_URL}/cancellation-policy`,
        },
    };
}
