      ...
      <CardContent>
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                  ...
                  <FormField
                    ...
                    render={({ field: { onChange, value } }) => (
                      <FormItem>
                        ...
                        <FormControl>
                           <ImageUploadInput id={`image-upload-${field.id}`} value={value} onChange={onChange} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
            ...
            <Button type="button" variant="outline" onClick={() => append({ title: '', category: '', image: 'https://placehold.co/600x400.png', link: 'https://example.com' })}>
                Add Portfolio Item
            </Button>
